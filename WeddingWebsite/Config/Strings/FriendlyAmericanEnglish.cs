...
public class FriendlyAmericanEnglish : StandardAmericanEnglish, IStringProvider
{
    ...
    public new string ClaimThisItemDescriptionDonation => "If you'd like to donate in our name, please mark a claim below. Once it's marked, you'll be presented with a direct link to the donation page. This can be undone if you change your mind.";
